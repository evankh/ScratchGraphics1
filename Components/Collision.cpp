...
void BoundingSphere::debugDraw() {
	GeometryComponent::drawSphere(mCenter, mRadius);
}
/*
void AABoundingCylinder::debugDraw() {
	GeometryComponent::drawUnitCylinder();//mCenter, mRadius, mHeight);
}
*/
void AABB::debugDraw() {
	//GeometryComponent::drawUnitBox();
	GeometryComponent::drawBox(mMin, mMax);
}
/*
void ArbitraryBoundingCylinder::debugDraw() {
	GeometryComponent::drawUnitCylinder();//mCylinder.mCenter, mCylinder.mRadius, mCylinder.mHeight, mTransform);
}

void ArbitraryBoundingBox::debugDraw() {
	GeometryComponent::drawUnitBox();//mBox.mMin, mBox.mMax, mTransform);
}
*/
void CollisionPlane::debugDraw() {
	//GeometryComponent::drawUnitQuad();
	return;
}
...
bool collides(CollisionComponent* a, CollisionComponent* b) {
	switch (a->mType) {
