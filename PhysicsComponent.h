...
public:
	...
	PhysicsComponent(Bounds* bounds, glm::vec3 vel, glm::vec3 acc, glm::vec3 angles, glm::vec3 aVels);	// For reading them in from Level files (MM is taken care of through transform functions)
	~PhysicsComponent();
